...
for (( counter = 64; counter <= 256; counter *= 2 )); do
        ...
        working_time=$(python3 resnet50_v2.py --batch_size $counter --gpu_mode $GPU_MODE --mixed_precision $MIXED_PRECISION --policy_type $POLICY_TYPE | grep Working | awk '{print $3}')
